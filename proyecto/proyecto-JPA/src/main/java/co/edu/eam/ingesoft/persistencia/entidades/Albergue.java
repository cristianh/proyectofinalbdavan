...
@NamedQueries({ @NamedQuery(name = "Albergue.ListarAlbergue", query = "SELECT a FROM Albergue a"),
	@NamedQuery(name = "Albergue.BuscarListaAlbergue", query = "SELECT a FROM Albergue a where a.idalbergue=:id") })
